...
using namespace std;
int main() {
	int hour, ten_minute, minute, ten_second, second, input;
	cin >> input;
	hour = input / 3600 % 24;

	ten_minute = input / 60 % 60 / 10;
	minute = input / 60 % 60 % 10;
	ten_second = input % 60 % 60 / 10;
	second = input % 60 % 60 % 10;
	cout << hour << ':' << ten_minute << minute << ':' << ten_second << second;
}